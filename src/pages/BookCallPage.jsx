...
const socialLinks = [
  ...
  {
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/in/edwin-torres-3a997115b',
    meta: 'edwin-torres-3a997115b',
    icon: (
      <svg viewBox="0 0 24 24" aria-hidden="true" className="h-4 w-4 fill-current">
        <path d="M4.98 3.5C4.98 4.88 3.86 6 2.48 6S0 4.88 0 3.5 1.12 1 2.48 1s2.5 1.12 2.5 2.5zM.5 8h4V24h-4V8zm7.5 0h3.8v2.2h.1c.53-1 1.82-2.2 3.75-2.2 4.01 0 4.75 2.64 4.75 6.07V24h-4v-7.1c0-1.7-.03-3.88-2.37-3.88-2.37 0-2.73 1.85-2.73 3.76V24h-4V8z" />
      </svg>
    ),
  },
  {
    label: 'Email',
    href: 'mailto:etorres2718@gmail.com',
    meta:"etorres2718@gmail.com",
    icon: (
      <svg viewBox="0 0 24 24" aria-hidden="true" className="h-4 w-4 fill-current">
